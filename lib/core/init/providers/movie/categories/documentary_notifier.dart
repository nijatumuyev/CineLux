...
class DocumentaryNotifier extends StateNotifier<Pagination> {
  DocumentaryNotifier([Pagination? state])
  ...
  Future<List<Movie>?> fetchMovies([int page = 1]) async {
    ...
    final String url =
        "$baseUrl$genre$apiKey&with_genres=99&page=$page&language=$langCode";
...
final documentaryNotifier =
    StateNotifierProvider<DocumentaryNotifier, Pagination>(
        (ref) => DocumentaryNotifier());
