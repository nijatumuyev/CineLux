...
class AnimationNotifier extends StateNotifier<Pagination> {
  AnimationNotifier([Pagination? state])
  ...
  Future<List<Movie>?> fetchMovies([int page = 1]) async {
    ...
    final String url =
        "$baseUrl$genre$apiKey&with_genres=16&page=$page&language=$langCode";
...
final animationNotifier = StateNotifierProvider<AnimationNotifier, Pagination>(
