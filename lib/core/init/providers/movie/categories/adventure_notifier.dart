...
class AdventureNotifier extends StateNotifier<Pagination> {
  AdventureNotifier([Pagination? state])
  ...
  Future<List<Movie>?> fetchMovies([int page = 1]) async {
    ...
    final String url =
        "$baseUrl$genre$apiKey&with_genres=12&page=$page&language=$langCode";
...
final adventureNotifier = StateNotifierProvider<AdventureNotifier, Pagination>(
    (ref) => AdventureNotifier());
