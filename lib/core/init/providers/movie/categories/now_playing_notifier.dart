...
class NowPlayingNotifier extends StateNotifier<Pagination> {
  NowPlayingNotifier([Pagination? state])
      : super(state ?? Pagination.initial()) {
    getMovies();
  }

  Future<List<Movie>?> fetchMovies([int page = 1]) async {
    const String genre = "/movie/now_playing";
...
final nowPlayingNotifier =
    StateNotifierProvider<NowPlayingNotifier, Pagination>(
