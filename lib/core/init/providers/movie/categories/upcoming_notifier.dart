...
class UpcomingNotifier extends StateNotifier<Pagination> {
  UpcomingNotifier([Pagination? state]) : super(state ?? Pagination.initial()) {
    getMovies();
  }

  Future<List<Movie>?> fetchMovies([int page = 1]) async {
    const String genre = "/movie/upcoming";
...
final upcomingNotifier = StateNotifierProvider<UpcomingNotifier, Pagination>(
