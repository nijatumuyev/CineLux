...
class ActionNotifier extends StateNotifier<Pagination> {
  ActionNotifier([Pagination? state]) : super(state ?? Pagination.initial()) {
    getMovies();
  }
...
final actionNotifier = StateNotifierProvider<ActionNotifier, Pagination>(
    (ref) => ActionNotifier());
